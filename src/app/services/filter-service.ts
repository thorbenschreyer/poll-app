...
surveyList = signal<Survey[]>([
...

  {
    ...
    name: 'Wie wichtig ist dir Bewegung im Arbeitsalltag?',
...

  {
    ...
    name: 'Welches Gaming-Genre bevorzugst du?',
...

  {
    ...
    name: 'Welche Weiterbildung interessiert dich am meisten?',
...

  {
    ...
    name: 'Wie wichtig ist dir eine flexible Arbeitszeit?',
...

  {
    ...
    name: 'Welche Technologie sollte stärker eingesetzt werden?',
...

  {
    ...
    category: 'Team Activities',
    name: 'Welches Teamevent würdest du gerne besuchen?',
...

  {
    ...
    category: 'Health & Wellness',
    name: 'Wie gut findest du unsere aktuellen Gesundheitsangebote?',
...

  {
    ...
    category: 'Gaming & Entertainment',
    name: 'Welches Spiel sollte beim nächsten Spieleabend gespielt werden?',
...

  {
    ...
    category: 'Education & Learning',
    name: 'Wie sollte unser internes Training verbessert werden?',
...

  {
    ...
    category: 'Lifestyle & Preferences',
    name: 'Welche Arbeitsumgebung bevorzugst du?',
...

  {
    ...
    category: 'Technology & Innovation',
    name: 'Welche digitalen Tools erleichtern deinen Arbeitsalltag?',
...

  {
    ...
    category: 'Team Activities',
    name: 'Wie oft sollten gemeinsame Aktivitäten stattfinden?',
...

  {
    ...
    category: 'Health & Wellness',
    name: 'Wie wichtig ist dir ein gesunder Arbeitsplatz?',
...

  {
    ...
    category: 'Gaming & Entertainment',
    name: 'Welche Unterhaltungsmöglichkeiten wünschst du dir?',
...

  {
    ...
    category: 'Education & Learning',
    name: 'Welche neuen Lernformate würdest du ausprobieren?',
...

  {
    ...
    category: 'Lifestyle & Preferences',
    name: 'Welche Benefits sind dir besonders wichtig?',
...

  {
    ...
    category: 'Technology & Innovation',
    name: 'Wie offen bist du für neue Technologien?',
...

  {
    ...
    category: 'Team Activities',
    name: 'Welche gemeinsame Aktivität sollten wir als Nächstes planen?',
...

  {
    ...
    category: 'Health & Wellness',
    name: 'Welche Gesundheitsangebote würdest du nutzen?',
